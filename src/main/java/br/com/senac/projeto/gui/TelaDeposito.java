...
import br.com.senac.projeto.persistencia.Deposito_ProdutoDao;
import br.com.senac.projeto.persistencia.Deposito_ProdutosDao;
...
public class TelaDeposito extends javax.swing.JFrame {
    ...
    private void preencherBoxDeposito() {
        ...
        List<String> depositos = depositoDao.listar();
    ...
    public void preencheTabela() {
        try {
            ...
            Deposito_ProdutosDao produtoDAO = new Deposito_ProdutosDao();
            ...
            if(tblProdutos.getSelectedRow() >= 0 ){
                ...
                if (qtdAtual == 0){
                    ...
                    if(resposta == 0){
                        ...
                        int idDeposito = deposito.obterNome(nomeFornecedor);
                        ...
                        Deposito_ProdutoDao produtoDao = new Deposito_ProdutoDao();
                        produtoDao.excluir(idDeposito, idProduto);
