...
public class TelaMovimentacao extends javax.swing.JFrame {
    ...
    private void preencherBoxProduto() {
        ...
        List<String> produtos = produtoDAO.listar(itemSelecionado);
    ...
    private void btnAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdicionarActionPerformed
        ...
        try{
            ...
            int idDeposito = deposito.obterNome(nomeDeposito);
            ...
            movimentacao.setId_Deposito(idDeposito);
            movimentacao.setId_Produto(idProduto);
            movimentacao.setQtd_Movimentacao(quantidade);
