...
import br.com.senac.projeto.persistencia.Deposito_Produto;
...
public class TelaAdicionarProdutos extends javax.swing.JFrame {
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        Deposito_Produto relacao = new Deposito_Produto();
        Deposito_ProdutoDao dao = new Deposito_ProdutoDao();
        ...
        try{
            ...
            relacao.setId_Deposito(idDeposito);
            relacao.setId_Produto(idProduto);
            relacao.setPonto_Reposicao(quantidade);
            relacao.setQtd_Atual(0);
