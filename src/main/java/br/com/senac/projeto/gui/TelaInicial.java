...
import br.com.senac.projeto.persistencia.Movimentacao_Geral;
import br.com.senac.projeto.persistencia.Movimentacao_GeralDao;
...
public class TelaInicial extends javax.swing.JFrame {
    ...
    public void preencheTabela() {
        try {
            Movimentacao_GeralDao movimentacaoDAO = new Movimentacao_GeralDao();
            List<Movimentacao_Geral> movimentacao = movimentacaoDAO.listar();

            String columns[] = {"Id", "Produto", "Deposito", "Preço", "QTD Movimentada", "Tipo"};
            String dados[][] = new String[movimentacao.size()][columns.length];

            int i = 0;
            for (Movimentacao_Geral d : movimentacao) {
                dados[i] = new String[]{
                    String.valueOf(d.getId()),
                    d.getNome_Produto(),
                    d.getNome_Deposito(),
                    String.valueOf(d.getPreco_Produto()),
                    String.valueOf(d.getQTD_Movimentacao()),
                    d.getTipo_Movimentacao()
                };
                i++;
            }
